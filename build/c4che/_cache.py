...
CFLAGS_MPI = ['-flto=auto', '-ffat-lto-objects', '-flto=auto']
...
DEFINES = ['NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE', 'HAVE_PACKET_H=1', 'HAVE_MPI=1', 'HAVE_IF_TUN_H=1']
...
INCLUDES_MPI = ['/usr/include/x86_64-linux-gnu/mpich']
...
LIBPATH_MPI = ['/usr/lib/x86_64-linux-gnu', '/home/praneeth/git/simbricks/lib/simbricks/base/', '/home/praneeth/git/simbricks/lib/simbricks/network/']
LIBPATH_PYEXT = []
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_MPI = ['mpichcxx', 'mpich', 'base', 'network']
LIB_PYEXT = []
LIB_RT = ['rt']
LIB_ST = '-l%s'
...
NS3_EXECUTABLE_PATH = ['/home/praneeth/git/simbricks/sims/external/ns-3/build/src/emu', '/home/praneeth/git/simbricks/sims/external/ns-3/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/home/praneeth/git/simbricks/sims/external/ns-3/build']
...
cfg_files = ['/home/praneeth/git/simbricks/sims/external/ns-3/build/ns3/config-store-config.h', '/home/praneeth/git/simbricks/sims/external/ns-3/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
...
define_key = ['HAVE_PACKET_H', 'HAVE_MPI', 'HAVE_IF_TUN_H']
