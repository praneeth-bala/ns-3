 ...
 */
#ifndef POINT_TO_POINT_HELPER_SIMBRICKS_H
#define POINT_TO_POINT_HELPER_SIMBRICKS_H
 ...
 * "mixins".
 */
class PointToPointHelperSimbricks : public PcapHelperForDevice,
...
public:
   ...
   * PointToPointNetDevice created through PointToPointHelperSimbricks::Install.
   */
   ...
   * by PointToPointHelperSimbricks::Install
   */
   ...
   * attributes configured by PointToPointHelperSimbricks::SetChannelAttribute,
