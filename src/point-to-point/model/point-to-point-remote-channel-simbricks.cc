...
#include "point-to-point-remote-channel-simbricks.h"
...
NS_LOG_COMPONENT_DEFINE ("PointToPointRemoteChannelSimbricks");

NS_OBJECT_ENSURE_REGISTERED (PointToPointRemoteChannelSimbricks);

TypeId
PointToPointRemoteChannelSimbricks::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PointToPointRemoteChannelSimbricks")
    .SetParent<PointToPointChannel> ()
    .SetGroupName ("PointToPoint")
    .AddConstructor<PointToPointRemoteChannelSimbricks> ()
  ;
  return tid;
}

PointToPointRemoteChannelSimbricks::PointToPointRemoteChannelSimbricks ()
  : PointToPointChannel ()
{
}
...
bool
PointToPointRemoteChannelSimbricks::TransmitStart (
  Ptr<const Packet> p,
